...
_Generated 2026-05-02 23:53:35_
...
| `sync_turn` | 0.00 ms | 0.00 ms | 0.04 ms | 500 ms |
| `on_pre_compress` | 0.00 ms | 0.01 ms | 0.03 ms | 500 ms |
| `on_session_end` | 0.00 ms | 0.00 ms | 0.03 ms | 500 ms |
| `on_memory_write` | 0.00 ms | 0.01 ms | 0.06 ms | 500 ms |
| `on_delegation` | 0.00 ms | 0.00 ms | 0.03 ms | 500 ms |

## Q3 — Background queue throughput

**Sustained** (paced producer; workers keep up):
- Delivered **5,000** of 5,000 in 0.303s = **16,475 jobs/sec**
- Delivery rate: **100.0%**

**Burst overflow** (producer floods, queue drops oldest):
- Enqueue cost: **1.46 µs/job** (14.6 ms total for 10,000 submits)
- Delivery rate: **7.67%** — 767 delivered before drop-oldest kicked in
...
- Background recalls completed during run: **15**
